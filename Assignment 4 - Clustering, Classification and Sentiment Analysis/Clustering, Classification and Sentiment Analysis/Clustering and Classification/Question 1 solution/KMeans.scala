...
import org.apache.spark.mllib.clustering.{KMeans, KMeansModel}
    ...
    val movieData=sc.textFile("/nxc161330/hw3/movies.dat").map(line=>line.split("::",2)).map(line=>(line(0)->line(1))).collect().toMap;
    val data = sc.textFile("/nxc161330/hw3/itemusermat")
