...
public class Top10 {
	public static class Top10_Mapper extends Mapper<LongWritable, Text, Text, FloatWritable> {
	...
	public static class Top10_Reducer extends Reducer<Text, FloatWritable, Text, FloatWritable> {

		HashMap<String, Float> map = new HashMap<String, Float>();

		@Override
		protected void reduce(Text business_id, Iterable<FloatWritable> stars, Context context)
				throws IOException, InterruptedException {
